// A private-state provider that keeps everything in memory instead of on
// disk, since this runs in the browser. Adapted from Midnight's own
// example-bboard reference implementation.
